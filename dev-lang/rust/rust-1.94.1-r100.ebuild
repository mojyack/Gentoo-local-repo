...
IUSE="big-endian +clippy cpu_flags_x86_sse2 debug dist +doc jemalloc llvm-libunwind lto"
...
src_configure() {
	...
	# Link against the system jemalloc
	use jemalloc && export JEMALLOC_OVERRIDE="${ESYSROOT}/usr/$(get_libdir)/libjemalloc.so"
